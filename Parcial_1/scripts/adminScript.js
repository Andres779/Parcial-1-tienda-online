        ...
        productos.forEach(producto => {
            contenedorProd.innerHTML += `
                <article class="producto">
                    ...
                    <a href="/Parcial_1/paginas/paginas_admin/admin_mostrar_producto.html?codigo=${producto.codigo}">Ver producto</a>
                    <a href="/Parcial_1/paginas/paginas_admin/admin_editar_producto.html?codigo=${producto.codigo}">Editar</a>
                </article>
            `;
        });
    }
            ...
            usuarios.forEach(u => {
                contenedorUser.innerHTML += `
                    <article class="usuario">
                        ...
                        <a href="/Parcial_1/paginas/paginas_admin/admin_mostrar_usuario.html?id=${u.id}">Ver usuario</a>
                        <a href="/Parcial_1/paginas/paginas_admin/admin_editar_usuario.html?id=${u.id}">Editar</a>
                    </article>
                `;
            });
        }
