document.addEventListener('DOMContentLoaded', () => {
    ...
    if (prod) {
        ...
        if (btnEditar) {
            btnEditar.href = `/Parcial_1/paginas/paginas_admin/admin_editar_producto.html?codigo=${prod.codigo}`;
        }
    } else {
        alert('Producto no encontrado.');
        window.location.href = '/Parcial_1/paginas/paginas_admin/admin_productos.html';
    }
});